...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _titleFont = [UIFont fontWithName:@"DaimlerCS-Regular" size:FSCalendarStandardTitleTextSize];
        _subtitleFont = [UIFont fontWithName:@"DaimlerCS-Regular" size:FSCalendarStandardSubtitleTextSize];
        _weekdayFont = [UIFont fontWithName:@"DaimlerCS-Regular" size:FSCalendarStandardWeekdayTextSize];
        _headerTitleFont = [UIFont fontWithName:@"DaimlerCS-Regular" size:FSCalendarStandardHeaderTextSize];
        
        _headerTitleColor = [UIColor blackColor]; //FSCalendarStandardTitleTextColor;
        _headerDateFormat = @"LLLL yyyy";
        _headerMinimumDissolvedAlpha = 0.2;
        _weekdayTextColor = [UIColor blackColor]; //FSCalendarStandardTitleTextColor;
        ...
        _backgroundColors[@(FSCalendarCellStateNormal)]      = [UIColor colorWithWhite:1 alpha:0.2];
        _backgroundColors[@(FSCalendarCellStateSelected)]    = [UIColor colorWithRed:0 green:153/255. blue:218/255. alpha:1]; //FSCalendarStandardSelectionColor;
        _backgroundColors[@(FSCalendarCellStateDisabled)]    = [UIColor colorWithWhite:1 alpha:0.1];
        _backgroundColors[@(FSCalendarCellStatePlaceholder)] = [UIColor colorWithWhite:1 alpha:0.2];
        ...
        _titleColors[@(FSCalendarCellStateDisabled)]    = [UIColor colorWithWhite:1 alpha:0.6];
        _titleColors[@(FSCalendarCellStatePlaceholder)] = [UIColor colorWithRed:153/255. green:153/255. blue:153/255. alpha:1];
        ...
        _borderRadius = 0.0;
        _eventDefaultColor = [UIColor clearColor]; //FSCalendarStandardEventDotColor;
        _eventSelectionColor = [UIColor clearColor]; //FSCalendarStandardEventDotColor;
