...
class ViewControllerUtils {
    ...
    func showActivityIndicator(uiView: UIView) {
        ...
        ViewControllerUtils.loadingView.backgroundColor = UIColorFromHex(rgbValue: 0x444444, alpha: 0.85)
        ...
        ViewControllerUtils.activityIndicator.color = .white //UIColor(red: 217/255, green: 37/255, blue: 43/255, alpha: 1)
        ...
        ViewControllerUtils.mainLabel.textColor = .white //UIColor(red: 217/255, green: 37/255, blue: 43/255, alpha: 1)
        ViewControllerUtils.mainLabel.font = UIFont(name: "DaimlerCS-Demi", size: 18)
        ...
        ViewControllerUtils.detailLabel.font = UIFont(name: "DaimlerCS-Demi", size: 14)
